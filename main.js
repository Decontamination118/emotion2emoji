...
classifier=ml5.imageClassifier("https://teachablemachine.withgoogle.com/models/9D6Aj-4lq/model.json",modelLoaded);
...
console.log('Model is Loaded !');
    ...
    function check()
{
    check_var=document.getElementById("captured_image");
    classifier.classify(check_var, gotResult);
}
function speak()
{
